<?php 
 //validasi jika username dan password benar
  ...
  include('fungsi/iuran keluar/fungsi_update_iuran_klr.php');
					...
					<div class="row">
                        <div class="col-sm-6  ">	
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan kode iuran keluar" name="kode_iuran" 
                                value="<?php echo $iuran["kode_iuran_keluar"] ?>">
                            </div>
                        </div>
			            <div class="col-sm-6  ">	
							<div class="form-group">
								<label>Nama</label>
								<input type="text" class="form-control" placeholder="Masukkan Nama penerima iuran" name="nama" 
