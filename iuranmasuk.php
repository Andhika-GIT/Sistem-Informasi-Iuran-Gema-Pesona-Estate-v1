...
//cek apakah sesuai status sudah login? kalau belum akan kembali ke form login
 if ( !isset($_SESSION['login']) ) 
    ...
    include("koneksi.php");
    include('fungsi/iuran masuk/fungsi_tampil_iuran_msk.php');
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-sm-10 card-title">
                      <h3 class=" ">Transaksi Iuran Masuk</h3>
                      <a type="button" class=" btn btn-success mr-1" href="export/masuk.php" target="_blank">
                        <i class="fas fa-file-export"></i> Ekspor/Cetak Data</i></a>
                      <a type="button" class=" btn btn-primary" href="add_iuran_msk.php">
                ...
                <div class="card-body">
                  ...
                  foreach($iuran as $p =>$iuran )
                  { ?>
                      <tr>
                        <td><?php echo $no++ ?></td>
                        <td><?php echo $iuran["kode_iuran_masuk"] ?></td>
                        <td><?php echo $iuran["nama"] ?></td>
                        <td><?php echo $iuran["keterangan"] ?></td>
                        <td><?php echo $iuran["tanggal"] ?></td>
                        <td><?php echo $iuran["metode_bayar"] ?></td>
                        <td><?php echo $iuran["jumlah"] ?></td>
                        <td align="center">
                          <div class="btn-group">
                            <a class="btn btn-success btn-sm"
                              href="edit_iuran_msk.php?id=<?php echo $iuran['kode_iuran_masuk'] ?>"><i
                                class="fas fa-pencil-alt"> EDIT</i></a>
                            <a class="btn btn-danger btn-sm ml-1"
                              href="fungsi/iuran masuk/fungsi_hapus_iuran_masuk.php?id=<?php echo $iuran['kode_iuran_masuk'] ?>"
