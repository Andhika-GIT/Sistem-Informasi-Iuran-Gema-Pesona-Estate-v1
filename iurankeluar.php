...
//cek apakah sesuai status sudah login? kalau belum akan kembali ke form login
 if ( !isset($_SESSION['login']) ) 
    ...
    include("koneksi.php");
    include('fungsi/iuran keluar/fungsi_tampil_iuran_klr.php');
                ...
                <div class="card-header">
                  <div class="row">
                    <div class="col-sm-10 card-title">
                      <h3 class=" ">Transaksi Iuran keluar</h3>
                      <a type="button" class=" btn btn-success mr-1" href="export/keluar.php" target="_blank">
                        <i class="fas fa-file-export"></i> Ekspor/Cetak Data</i></a>
                      <a type="button" class=" btn btn-primary" href="add_iuran_klr.php">
                        ...
                        <td align="center">
                          <div class="btn-group">
                            <a class="btn btn-success btn-sm"
                              href="edit_iuran_klr.php?id=<?php echo $iuran['kode_iuran_keluar'] ?>"><i
                                class="fas fa-pencil-alt"> EDIT</i></a>
                            <a class="btn btn-danger btn-sm ml-1"
                              href="fungsi/iuran keluar/fungsi_hapus_iuran_klr.php?id=<?php echo $iuran['kode_iuran_keluar'] ?>"
